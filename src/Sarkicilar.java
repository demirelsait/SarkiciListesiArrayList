...
public class Sarkicilar {
    ...
    //ArrayList<String>() in sonunda parantez koymadığım için hata aldım.
    ...
    public void sarkici_ara(String sarkici_isimi) {
        int pozisyon =sarkici_listesi.indexOf(sarkici_isimi);
        if(pozisyon>=0){
            System.out.println("Şarkıcı Bulundu...");
            System.out.println(sarkici_isimi + " isimli şarkıcı " + (pozisyon + 1) + ". pozisyonda");
        }
        else {
